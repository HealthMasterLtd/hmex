...
const journeySteps = [
  {
    n: "01", title: "Answer simple questions",
  ...
  {
    n: "03", title: "Get your personal report",
    ...
    <div className="min-h-screen transition-colors duration-500" style={{ background: surface.bg }}>
        ...
        <div
          ...
          style={{
            background: isDark
              ...
              : "radial-gradient(ellipse at 85% 15%, rgba(13,148,136,.10) 0%, transparent 65%)",
          }}
        />
        ...
        <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl grid-cols-1 items-center gap-10 px-6 py-28 lg:grid-cols-2 lg:gap-20 lg:px-16 lg:py-0">
          ...
          >
            ...
            <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center">
              ...
              <span className="text-[12px]" style={{ color: surface.muted }}>Free · Under 2 minutes</span>
            </div>
          </div>

          {/* Image keeps rounded-lg */}
      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-16">
          ...
          <div className="grid grid-cols-1 gap-px sm:grid-cols-2 lg:grid-cols-4" style={{ background: surface.border }}>
            {benefits.map((b, i) => {
              const Icon = b.icon;
              return (
                <div
      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-16">
          ...
          <div className="grid grid-cols-1 gap-px md:grid-cols-3" style={{ background: surface.border }}>
            {journeySteps.map((step, i) => (
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="h-px flex-1 mx-4" style={{ background: surface.border }} />
                </div>

                <div>
                  <h3 className="mb-3 text-[15px] font-bold" style={{ color: surface.text }}>{step.title}</h3>
                  <p className="text-[13.5px] leading-[1.8]" style={{ color: surface.muted }}>{step.body}</p>
                </div>
                ...
                <ul className="flex flex-col gap-2.5 pt-1">
                  {step.checks.map((c, ci) => (
                    <li key={ci} className="flex items-center gap-2.5">
                      ...
                      <span className="text-[12.5px]" style={{ color: surface.muted }}>{c}</span>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="flex flex-col gap-0">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                >
                  <span className="text-[14.5px] font-semibold" style={{ color: surface.text }}>{faq.q}</span>
                  <ChevronRight
                ...
                {openFaq === i && (
                  <p className="pb-5 text-[13.5px] leading-[1.8]" style={{ color: surface.muted }}>{faq.a}</p>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          >
            ...
            <div className="relative z-10">
              <Link href="/questions">
                <button
                  className="group inline-flex items-center gap-3 bg-white px-6 py-3.5 text-sm font-bold text-teal-700 transition-all hover:bg-white/92 active:scale-[.98]"
                  style={{ borderRadius: 0 }}
                >
                  Start Free Assessment
                  <span
                    className="flex h-6 w-6 items-center justify-center rounded-full bg-teal-600 text-white transition-transform group-hover:translate-x-0.5"
                  >
          ...
          {/* Right — theme-aware */}
          <div
            className="flex flex-col justify-between gap-8 px-10 py-14 md:px-16 md:py-16 xl:px-20 transition-colors duration-500"
            style={{
          ...
          >
            <div className="flex flex-col gap-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em]" style={{ color: surface.subtle }}>
                Why It Matters
              </p>
              <h3
              ...
              <p className="max-w-[38ch] text-[14px] leading-[1.8]" style={{ color: surface.muted }}>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[{ v: "2 min", l: "to complete" }, { v: "12", l: "conditions checked" }, { v: "Free", l: "always" }].map((s, i) => (
                  <div key={i} className="flex flex-col gap-1">
                    <span className="text-[1.05rem] font-bold tabular-nums" style={{ color: surface.text }}>{s.v}</span>
                    <span className="text-[11px]" style={{ color: surface.subtle }}>{s.l}</span>
                  </div>
                ))}
              </div>
              <div className="h-px w-full" style={{ background: surface.border }} />
