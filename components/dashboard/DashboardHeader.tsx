        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: 10, color: S.muted, margin: 0 }}>
          ...
          >
            {[
              ...
              <React.Fragment key={i}>
                {i > 0 && (
                  <div
                    style={{ width: 1, background: S.border, margin: "0 4px" }}
                  />
                )}
            ...
            >
              ...
              <p
                style={{
                  fontSize: 10,
                  fontWeight: 700,
                  color: unlocked ? accentColor : S.text,
                  margin: 0,
                }}
              >
          ...
          {unlocked ? (
            ...
            >
              ...
              <strong style={{ color: S.text }}>
                {XP_THRESHOLD - available} more XP
              </strong>{" "}
              to unlock a free doctor consultation.
            </p>
          )}
        </div>
      )}
    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        ...
        >
          ...
          <div
            style={{ borderTop: `1px solid ${S.border}`, margin: "4px 0" }}
          />
