...
export default function AwarenessSection() {
  ...
  const c3 = useCountUp(80, 1300, visible);
  ...
  return (
    ...
    >
      ...
      {/* Overlay — always dark-tinted regardless of theme (content area) */}
      <div
        className="absolute inset-0"
        style={{
          background: "linear-gradient(160deg, rgba(4,15,30,.84) 0%, rgba(4,28,22,.78) 100%)",
        }}
      />
